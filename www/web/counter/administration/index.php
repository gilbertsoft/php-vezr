...
# optionales Cookie zum Blocken des Administrators wenn erforderlich l�schen oder setzen
if( chC_logged_in() == 'admin' )
{
	# neue Einstellung gesendet. Da die Einstellungen erst sp�ter in vieweditconfig ge�ndert werden, kann nicht $_CHC_CONFIG  mit "alter" Einstellung gepr�ft werden
