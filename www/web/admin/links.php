...
echo '<form name="update_link" method="post" action="?cat=links">
	  ...
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		while($row_linkCat = mysqli_fetch_array($sql))
		{
			echo '<tr>
					<td width="150"></td>
					<td><input type="radio" name="linkCat" value="'.$row_linkCat["linkCatID"].'" id="linkCat"'; if ($row_link["linkCat"] == $row_linkCat["linkCatID"]) echo "checked"; echo'>&nbsp; '.$row_linkCat["linkCatName"].'</td>
				  </tr>';
		}
		echo '
		<tr>
