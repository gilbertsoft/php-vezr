...
echo '<form name="update" method="post" action="?cat=newcontent">
      ...
      <b>Content-Page '.$row_content["contentName"].'&quot; bearbeiten:</b><br><br>
	   <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			<td width="150">&nbsp;</td>
			<td><input type="radio" name="contentCat" value="2" id="contentCat" '; if ($row_content["contentCat"] == 2) echo "checked"; echo '>&nbsp; &Uuml;ber VeZR</td>
		</tr>
		<tr>
			<td width="150">&nbsp;</td>
			<td><input type="radio" name="contentCat" value="3" id="contentCat" '; if ($row_content["contentCat"] == 3) echo "checked"; echo '>&nbsp; Programm</td>
		</tr>
		<tr>
			<td width="150">&nbsp;</td>
			<td><input type="radio" name="contentCat" value="4" id="contentCat" '; if ($row_content["contentCat"] == 4) echo "checked"; echo '>&nbsp; B&ouml;rse Z&uuml;rich</td>
		</tr>
		<tr>
